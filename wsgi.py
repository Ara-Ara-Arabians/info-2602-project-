...
@click.argument("departure", default = "7pm")
@click.argument("arrival", default = "7pm")
@click.argument("distance", default = 10)
def create_route_function(origin, destination, vehicle, departure, arrival, distance):
